      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section id='tc-container'>
          <div className="container">
            ...
            <p>
              Por haber comprado boletería para el show de Kendrick Lamar, podrás acceder de manera gratuita por cada boleta que hayas comprado a una cortesía de los eventos habilitados para acceder al beneficio, mediante la modalidad de redención de boletería según los presentes términos y condiciones.
            </p>
            <ol>
              <li>
                <strong>
                  Eventos habilitados para redención de boletas
                </strong>
              </li>
            </ol>
            <p>
              Los compradores podrán acceder, de acuerdo con la disponibilidad de aforo, a las siguientes presentaciones:
            </p>
            <ul>
              <li>
                <strong>
            ...
            <ul>
              <li>
                Cigarrillos, cigarrillos electrónicos, vapeadores.
              </li>
              <li>
                Cámaras fotográficas, videograbadoras, filmadoras o equipos similares.
              </li>
              <li>
                Armas de fuego, armas blancas o punzocortantes.
              </li>
              <li>
              ...
              <li>
                Comida o bebida ajena al inmueble.
              </li>
              <li>
                Botellas de vidrio o plástico.
              </li>
              <li>
                GoPro poles/selfie sticks, paraguas, cascos.
              </li>
              <li>
                Cualquier otra informada por Ticketmaster en sus términos y condiciones o los del evento.
              </li>
            </ul>
            <ol>
              <li>
            ...
            <ol>
              <li>
                <strong>
                  Derechos de admisión, seguridad y convivencia
                </strong>
              </li>
            </ol>
            <ul>
              ...
              <li>
                Quien se rehúse a cumplir con controles de ingreso o medidas de seguridad podrá ser retirado del evento sin devolución de dinero.
              </li>
            </ul>
            <ol>
              <li>
